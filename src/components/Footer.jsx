...
export default function Footer() {
  return (
    <section className="bg-[#DEF5EF]">
      <div className="bg-[#DEF5EF] sm:flex sm:justify-start      sm:flex-wrap sm:space-x-0 sm:p-7   lg:justify-between lg:items-center   md:justify-center font-sanbs pb-8 container mx-auto  sm:pl-[60px] lg:pl-[35px] lg:pr-[40px]">
