  ...
  return (
    <div className="bg-[#25262F] p-3 sm:p-16 font-sans  ">
      <div className="flex flex-col items-center pt-12">
        ...
        <div className="text-white font-bold text-4xl p-6">What I offer</div>
      </div>

      <div className="md:grid md:grid-cols-2 md:mr-9 place-content-center md:place-content-center lg:place-content-center  md:gap-x-[80px]  md:gap-y-[0px] lg:gap-x-[90px] lg:ml-[-10px]  xl:gap-x-[100px] 2xl:ml-[100px] 2xl:place-content-center-center">
